...
public class Collectibles : MonoBehaviour
{
    ...
    public static Collectible.CollectibleData GetData(CollectibleName collectible)
    {
        switch (collectible)
        {
            case CollectibleName.WaterOrbMini:
                return new Collectible.CollectibleData
                {
                    ...
                    price = 5,
                    rarity = Collectible.CollectibleData.Rarity.Common,
            ...
            case CollectibleName.WaterOrb:
                return new Collectible.CollectibleData
                {
                    ...
                    monsterBase = Language.GetText(Language.Text.Monster_NameWater),
                    price = 25,
                    rarity = Collectible.CollectibleData.Rarity.Uncommon,
                    starterState = ItemData.ItemState.Locked,
                    collectionState = CollectionPrefs.CollectionState.Missing,
            ...
            case CollectibleName.WaterOrbBig:
                return new Collectible.CollectibleData
                {
                    ...
                    monsterBase = Language.GetText(Language.Text.Monster_NameWater),
                    price = 50,
                    rarity = Collectible.CollectibleData.Rarity.Rare,
                    starterState = ItemData.ItemState.Locked,
                    collectionState = CollectionPrefs.CollectionState.Missing,
