...
namespace Gui
{
    ...
    public class Language : MonoBehaviour
    {
        ...
        public enum Text
        {
            ...
            Achievement_NameTrainingManiac,
            Achievement_DescTrainingManiac,
            ...
            Monster_NameFire,
            Monster_NameSlime,
            Monster_NameTrainingDummy,
            Monster_DescWater,
            Monster_DescWood,
            Monster_DescFire,
            Monster_DescSlime,
            Monster_DescTrainingDummy,
            Monster_AbilWater,
            Monster_AbilWood,
            Monster_AbilFire,
            Monster_AbilSlime,
            Monster_AbilTrainingDummy,
            #endregion
            #region LevelIntro
            LevelIntro_Title,
            LevelIntro_Defeat,
            ...
            switch (PlayerPrefs2.SelectedLanguage)
            {
                case Languages.Spanish:
                    switch (text)
                    {
                        ...
                        case Text.Achievement_NameTrainingManiac:
                            return "Adicto al entrenamiento";
                        ...
                        case Text.Achievement_DescTrainingManiac:
                            return "Destroza 50 muñecos de entrenamiento";
                        ...
                        case Text.Monster_DescTrainingDummy:
                            return "Perfecto para entrenar tu espada.";
                ...
                case Languages.English:
                    switch (text)
                    {
                        ...
                        case Text.Achievement_DescTrainingManiac:
                            return "Destroy 50 training dummies.";
                        case Text.Achievement_DescGatherer:
                        ...
                        case Text.Monster_DescWood:
                            return "When the forest was invaded with the diabolic energy, this monsters where born.";
                        case Text.Monster_DescFire:
                        ...
                        case Text.Monster_DescTrainingDummy:
                            return "Perfect for training that sword of yours.";
                        case Text.Monster_AbilWater:
                            return "None.";
                        case Text.Monster_AbilWood:
            ...
            switch (PlayerPrefs2.SelectedLanguage)
            {
                case Languages.Spanish:
                    switch (text)
                    {
                        ...
                        case TutorialText.TrainingMaster12:
                            return "Cada espada tiene un rango de ataque diferente y tus cortes solo harán daño a los enemigos dentro de este rango.";
                        case TutorialText.TrainingMaster13:
                            return "Cuando un enemigo este en rango podras ver un brillo a su alrededor.";
                ...
                case Languages.English:
                    switch (text)
                    {
                        ...
                        case TutorialText.TrainingMaster12:
                            return "Each sword has a different attack range and your slashes will only damage enemies within this range.";
                        case TutorialText.TrainingMaster13:
                            return "When an enemy is in range you will see a glow around it.";
                        case TutorialText.TrainingMaster14:
