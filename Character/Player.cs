...
namespace Character
{
    public class Player : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            // Sets all the equipment to the correct one
            #region Equipment
            ...
            var tempArmor = PlayerPrefs2.GetEquipedHelmet();
            if (tempArmor != null)
            {
            ...
            {
                var spriteRenderer = chestplate.GetComponent<SpriteRenderer>();
                spriteRenderer.sprite = null;
        ...
        public void Damage(int enemyPower)
        {
            if (shieldPoints < 1 || !shield)
            {
                ...
                var newScreen = Instantiate(damageScreen, GameManager.instance.HUD.transform);
        ...
        public int ExpandVision(int maxRange)
        {
            ...
            var originalRange = sword.data.range;
